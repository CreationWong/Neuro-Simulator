...
from ..neuro.core import Agent as LocalAgent
...
class BuiltinAgentWrapper(BaseAgent):
    ...
    async def create_memory_block(
        ...
        block_id = await self.agent_instance.memory_manager.create_core_memory_block(
    ...
    async def update_memory_block(
        ...
        await self.agent_instance.memory_manager.update_core_memory_block(
    ...
    async def get_available_tools(self) -> str:
        ...
        schemas = self.agent_instance.tool_manager.get_tool_schemas_for_agent(
            "neuro_agent"
        )
        return self.agent_instance._format_tool_schemas_for_prompt(schemas)

    async def execute_tool(self, tool_name: str, params: Dict[str, Any]) -> Any:
        result = await self.agent_instance.tool_manager.execute_tool(
            tool_name, **params
        )
